...
with st.sidebar:
    ...
    with col1:
        ...
        with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
            ...
            with open(r'C:\Users\Waz\Desktop\lifepulse-pro\templates\template_beneficiarios.xlsx', 'rb') as f:
                zip_file.writestr('template_beneficiarios.xlsx', f.read())
            
            # Adicionar template protocolos
            with open(r'C:\Users\Waz\Desktop\lifepulse-pro\templates\template_protocolos.xlsx', 'rb') as f:
                zip_file.writestr('template_protocolos.xlsx', f.read())
            
            # Adicionar template utilização
            with open(r'C:\Users\Waz\Desktop\lifepulse-pro\templates\template_utilizacao.xlsx', 'rb') as f:
